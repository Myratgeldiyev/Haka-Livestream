...
export default function BankTransferBindScreen() {
	const insets = useSafeAreaInsets()
	const setBoundBank = usePaymentsStore(s => s.setBoundBank)
	...
	const handleBind = useCallback(() => {
		...
		router.back()
	}, [accountName, accountNumber, bankName, setBoundBank])
		...
		<View style={styles.root}>
			...
			<SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
				<View style={[styles.header, { paddingTop: insets.top }]}>
					...
					<Text style={styles.headerTitle}>Bank Transfer Bind</Text>
