...
export default function BinanceBindScreen() {
	const insets = useSafeAreaInsets()
	const setBoundBinance = usePaymentsStore(s => s.setBoundBinance)
	...
	const handleBind = useCallback(() => {
		...
		setBoundBinance({ wallet_address: wallet, network: net })
		router.back()
	}, [walletAddress, confirmWalletAddress, network, setBoundBinance])
