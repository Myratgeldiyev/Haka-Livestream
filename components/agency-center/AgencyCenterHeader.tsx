...
interface AgencyCenterHeaderProps {
	onBack?: () => void
}

export function AgencyCenterHeader({ onBack }: AgencyCenterHeaderProps) {
	return (
		<View style={styles.container}>
			...
			<Text style={styles.title}>{AGENCY_CENTER.headerTitle}</Text>
