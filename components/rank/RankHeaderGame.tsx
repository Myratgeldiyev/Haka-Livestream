...
export const RankHeaderGame: React.FC<Props> = ({ backgroundImage }) => {
	const insets = useSafeAreaInsets()
	const [active, setActive] = useState<'Top-Gamer' | 'Teaan Patti'>('Top-Gamer')
		...
		<ImageBackground source={backgroundImage} style={styles.container}>
			...
			<View style={styles.center}>
				<View style={styles.segment}>
					{(['Top-Gamer', 'Teaan Patti'] as const).map(item => {
