...
function UsdcIcon(props: any) {
	return (
		<Svg
			...
			{...props}
		>
			<Circle cx={20} cy={20} r={20} fill='url(#pattern0_2300_696)' />
			<Defs>
				<Pattern
					id='pattern0_2300_696'
					patternContentUnits='objectBoundingBox'
					width={1}
					height={1}
				>
					<Use xlinkHref='#image0_2300_696' transform='scale(.005)' />
				</Pattern>
				<Image
					id='image0_2300_696'
					width={200}
