...
import { ANIMATION_DURATION } from '../components/room-item-overlays/item-overlay.styles'
import type {
	UseItemOverlayAnimationConfig,
	UseItemOverlayAnimationReturn,
} from '../components/room-item-overlays/item-overlay.types'

export function useItemOverlayAnimation(
	config: UseItemOverlayAnimationConfig,
): UseItemOverlayAnimationReturn {
